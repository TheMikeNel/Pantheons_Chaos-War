...
public class LevelManagerScript : MonoBehaviour
{
    ...
    [SerializeField] public static int enemCountOnFirstWave = 5;
    [SerializeField] public static float enemWaveDamageMultiplier = 1f, enemWaveHealthMultiplier = 1f;
    [SerializeField, Tooltip("Multiply enemy count on next waves")] public static float enemCountMultiplier = 1.5f;
    ...
    [SerializeField] public static float enemBaseDamageMultiplier = 1f, enemBaseHealthMultiplier = 1f;
